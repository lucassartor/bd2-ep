...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  if (data.bool) {
    ...
    console.error("Erro ao carregar os dados da tabela:", data.error);
  }
});
...
function displayTableData(fields, dataObject) {
  ...
  bodyTitle.textContent = "Edite a linha:";
  ...
  editButton.textContent = "Editar linha";
  ...
  getQueryButton.textContent = "Ver query";
  ...
  getQueryButton.addEventListener("click", async () => {
    ...
    try {
      ...
      console.error(error);
      alert(
        "ERRO : Cheque se as colunas sem valor default estao preenchidas \nVeja o console para mais informação."
      );
    }
  });
